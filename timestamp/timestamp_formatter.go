...
func GetTimestampFormatter() *TimestampFormatter {
...
func (tf *TimestampFormatter)Format(format string, timestamp time.Time) string {
	formattedTime := timefmt.Format(timestamp, format)
	if formattedTime != "" {
